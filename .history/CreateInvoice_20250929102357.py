...
class InvoiceManager:
    ...
    def send_invoice_email(
        ...
        try:
            ...
            msg['Subject'] = f"{'Kreditnota' if credit_memo else 'Faktura'} #{invoice_number} - ST_Faktura"

            # Email body
            body = f"""
Kære {customer_name},

Vedhæftet finder du {'kreditnota' if credit_memo else 'faktura'} #{invoice_number}.

Betalingsfristen er {company_details.get('payment_terms_days', 8)} dage fra fakturadato.
