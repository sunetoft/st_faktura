...
class TaskManager:
    ...
    def get_customers(self) -> List[Dict[str, str]]:
        ...
        try:
            ...
            customers_data = self.sheets_client.read_sheet(self.customer_spreadsheet_id, "A:H")
    ...
    def get_task_types(self) -> List[str]:
        ...
        try:
            ...
            tasktype_data = self.sheets_client.read_sheet(self.tasktype_spreadsheet_id, "A:A")
    ...
    def setup_tasks_spreadsheet_headers(self) -> None:
        ...
        try:
            ...
            tasks_data = self.sheets_client.read_sheet(self.tasks_spreadsheet_id, "A:E")
