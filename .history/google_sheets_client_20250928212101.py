...
class GoogleSheetsClient:
    ...
    def __init__(self, auth_method: str = "service_account", config_dir: Optional[str] = None):
        """
    ...
    def _authenticate_oauth(self) -> None:
        ...
        token_file = os.path.join(
            self.config_dir, 
            os.getenv('OAUTH_TOKEN_FILE', 'token.pickle')
        )
        credentials_file = os.path.join(
            self.config_dir, 
            os.getenv('OAUTH_CREDENTIALS_FILE', 'credentials.json')
        )
    ...
    def _build_service(self):
        ...
        try:
            ...
            print("✅ Google Sheets API service ready")
        except Exception as e:
    ...
    def write_sheet(self, spreadsheet_id: str, range_name: str, 
                   values: List[List[Any]], value_input_option: str = "RAW"):
        """
        ...
        try:
            ...
            print(f"✅ Updated {updated_cells} cells in sheet")
            return result
    ...
    def write_dataframe_to_sheet(self, spreadsheet_id: str, range_name: str, 
                                df: pd.DataFrame, include_header: bool = True):
        """
    ...
    def append_to_sheet(self, spreadsheet_id: str, range_name: str, 
        ...
        try:
            ...
            print(f"✅ Appended {updated_cells} cells to sheet")
            return result
    ...
    def get_sheet_info(self, spreadsheet_id: str):
        ...
        try:
            ...
            print(f"✅ Sheet info: {title} with {len(sheets)} sheets")
            return info
